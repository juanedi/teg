class TegBoard extends HTMLElement {
  ...
  copyStylesheet(stylesheet, svgDoc) {
    const defs = svgDoc.getElementsByTagNameNS("http://www.w3.org/2000/svg", "defs")[0]
    if (!defs) { return }

    const oldStylesheet = svgDoc.getElementById('cloned-stylesheet')
    if (oldStylesheet) {
  ...
  connectedCallback() {
    ...
    embed.addEventListener("load", () => {
      ...
      const stylesheet = this.children[0]
      if (stylesheet) {
